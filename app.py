...
def index():
    ...
    # Graph 1
    df = pd.read_csv('./static/data/avg_yearly.csv')
    ...
    # Graph 4
    df_historic_iso = pd.read_csv('./static/data/df_historic_iso.csv')
    ...
    # Graph 5
    df_2021_region = pd.read_csv('./static/data/women_percent_as_of2021_with_regions.csv')
    ...
    # Graph 6
    df = pd.read_csv('./static/data/barchart.csv')
